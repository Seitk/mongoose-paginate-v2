  ...
  _createClass(PaginationParametersHelper, [
    ...
    },
    {
      ...
      value: function optObjectOrString(option) {
        ...
        var openingBrackets = ['{', '['];
        var closingBrackets = ['}', ']'];
        var firstCharIsBracket =
          option[0] && openingBrackets.includes(option[0]);
        var lastCharIsBracket =
    ...
    },
    {
      ...
      value: function getQuery() {
        var _this$query;
        var filtersQueryParameter =
          (_this$query = this.query) === null || _this$query === void 0
            ? void 0
            : _this$query.query;
    ...
    },
    {
      ...
      value: function get() {
        return [
          _objectSpread({}, this.getQuery()),
          _objectSpread({}, this.getOptions()),
        ];
      },
    },
  ]);
